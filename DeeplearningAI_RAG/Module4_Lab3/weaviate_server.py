...
# Embedded-Weaviate persistence dir. On Coursera this is a fixed jovyan path; locally
# fall back to a writable ./weaviate_data folder next to this file (created if absent).
COLLECTIONS_PATH = os.environ.get(
    "COLLECTIONS_PATH",
    os.path.join(os.path.dirname(os.path.abspath(__file__)), "weaviate_data"),
)
...
with suppress_subprocess_output():
    client = weaviate.connect_to_embedded(
        persistence_data_path=COLLECTIONS_PATH,
        #version="1.28.3",
