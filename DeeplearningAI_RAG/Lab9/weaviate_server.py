...
# COLLECTIONS_PATH is the embedded-Weaviate persistence dir. On Coursera it's an env
# var; locally fall back to the bundled ./data folder (next to this file) that holds
