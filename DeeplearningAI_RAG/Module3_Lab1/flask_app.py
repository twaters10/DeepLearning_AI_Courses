...
# MODEL_M3 is a Coursera-specific cache dir. Locally fall back to the default
# HuggingFace cache (None) so the reranker model downloads on first use.
reranker = FlagReranker('BAAI/bge-reranker-base', cache_dir=os.environ.get("MODEL_M3"), use_fp16=False)
